...
Quantity Node는 **물리량, 수치, 화폐** 등을 표현하는 가변 길이 Node 타입이다.

**핵심 특징:**
- **가변 길이:** 4~6워드 (값 크기에 따라)
...
Quantity Node:
  1st: [1100000 101] + [000001]    - Prefix + kg
...
Quantity Node:
  1st: [1100000 101] + [000000]    - Prefix + meter
...
Quantity Node:
  1st: [1100000 101] + [010100]    - Prefix + celsius
...
### 10.4 "$2,500,000 (250만 달러)"

```
값: 2,500,000, 단위: CURRENCY (0x20), 통화: USD (0x00)

Quantity Node:
  1st: [1100000 101] + [100000]    - Prefix + CURRENCY
