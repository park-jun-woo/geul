...
| 타입 | Prefix | 비트 |
|------|--------|------|
| Tiny Verb Edge | `11001` | 5 |
| Verb Edge (Short/Full) | `110001` | 6 |
| **Entity** | **`1100001`** | **7** |
| Triple Edge | `11000001` | 8 |
| Clause Edge | `110000001` | 9 |
...
## 10. 비교: Verb Edge vs Entity

| | Verb Edge | Entity |
|--|-----------|--------|
| 소형 | Tiny (2워드) | - |
| 중형 | Short (3워드) | 약식/추상 (3워드) |
| 대형 | Full (5워드) | 정식 (5워드) |
| 분기 | Type 1비트 | Lane + UIDflag |
| TID 위치 | 뒤따름 | 마지막 워드 |
...
**v0.1 주요 사항:**
- Prefix 7비트 (`1100001`)
- Lane이 Prefix 바로 다음 (bit 8)
- 가변 워드: 약식/추상 3워드, 정식 5워드
- Lane=0 개체, Lane=1 추상개체
- Number 2비트 (알수없음/단수/소수/다수)
- TID가 항상 마지막 워드