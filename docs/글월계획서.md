...
interface Triple {
  id: string           // Edge ID
  ctx: string          // Context SIDX
  subj: string         // Subject SIDX
  prop: number         // Property ID (워드넷)
  obj: string          // Object SIDX
}
```
...
interface Event6 {
  ...
  ctx: string          // Context SIDX
  who?: string         // 누가 (SIDX)
  what?: string        // 무엇을 (SIDX)
  whom?: string        // 누구를 (SIDX)
  when?: string        // 언제 (ISO datetime or SIDX)
  where?: string       // 어디서 (SIDX)
  why?: string         // 왜 (SIDX)
  description?: string // 설명
}
```
