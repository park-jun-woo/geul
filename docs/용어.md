...
### 1.2 WMS (World Management System)
...
- 구현 방향:
  - 1차: WMS의 CSR/비트마스크로 **하드 필터링** (가능성 없는 룰 제거)
...
- 정의:  
  글월/GEUL 기반 글DBMS/WMS 내부에 탑재되는 **초경량 논리 신경망 모듈**.  
- 입력:
...
> WMS **코어 바깥에 둘 수 있는 상위 계층 개념**으로 합의된 상태.  
