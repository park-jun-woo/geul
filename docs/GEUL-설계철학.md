# GEUL-설계철학.md  
*GEUL (General Embedding Universal Language) 설계 철학 v2.1*
...
### 5.2 원칙 2: World-agnostic, POV-aware
...
## 10. 요약 – GEUL 설계 철학 다섯 줄

1. **추론의 과정을 기록한다.**  
   AI의 생각은 버려지지 않고, 구조화되어 저장되어야 한다.

2. **우리는 Fact 대신 Claim을 다룬다.**  
...
5. **Core/Extension/Custom의 3층 구조로 열린 표준을 지향한다.**  
   리얼월드·가상세계·기업·개인은 각각 자기 세계를 확장할 수 있다.
...
|------|------|------|
| v1.0 | 2026-01-29 | 초안 |
| v2.0 | 2026-01-30 | 내부 IR, 오픈소스, 창의성 경제 추가 |
| v2.1 | 2026-01-30 | **"추론 과정 기록" 철학을 Section 1으로 이동**, 경제적/인간 가치 섹션 제거, 핵심 설계 철학에 집중 |
